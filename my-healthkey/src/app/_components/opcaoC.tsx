  ...
  return (
    <div className="relative group mt-6 mb-24">
      <div className="ml-16 mt-4 mb-2">
        <h1 className="text-3xl font-bold text-gray-800 font-mono">Loja C</h1>
      </div>
      <div className="overflow-hidden rounded-xl mx-16" ref={emblaRef}>
        <div className="flex">
          {produto.map((produto) => (
            ...
            >
              <div className="bg-white rounded-2xl p-6 h-52 w-full flex items-center justify-center gap-4 shadow-sm">
